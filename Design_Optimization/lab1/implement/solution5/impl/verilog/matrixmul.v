...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_54 <= 2'd0;
    end else if ((~((icmp_ln56_fu_83_p2 == 1'd0) & (1'b0 == a_empty_n)) & (icmp_ln56_fu_83_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_fu_54 <= add_ln56_fu_89_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln56_fu_83_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((~((icmp_ln56_fu_83_p2 == 1'd0) & (1'b0 == a_empty_n)) & (icmp_ln56_fu_83_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        a_read = 1'b1;
    end else begin
        a_read = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln56_fu_83_p2 == 1'd0) & (1'b0 == a_empty_n))) begin
...
always @ (*) begin
    if ((~((icmp_ln56_fu_83_p2 == 1'd0) & (1'b0 == a_empty_n)) & (icmp_ln56_fu_83_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign add_ln56_fu_89_p2 = (i_fu_54 + 2'd1);
...
always @ (*) begin
    ap_block_state2 = ((icmp_ln56_fu_83_p2 == 1'd0) & (1'b0 == a_empty_n));
end
...
assign icmp_ln56_fu_83_p2 = ((i_fu_54 == 2'd3) ? 1'b1 : 1'b0);
